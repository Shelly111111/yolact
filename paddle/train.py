...
parser.add_argument('--resume', default='weights/yolact_base_0_1.pdparams', type=str,
...
parser.add_argument('--validation_size', default=5, type=int,
...
class CustomDataParallel(paddle.DataParallel):
    ...
    def gather(self, outputs, output_device):
        ...
        for k in outputs[0]:
            out[k] = paddle.stack([output[k].to(output_device) for output in outputs])
...
def train():
    ...
    optimizer = optim.Momentum(parameters=net.parameters(), learning_rate=args.lr, momentum=args.momentum,
